...
local UpgradeData = {
    ...
    },
    {
        id          = "void_blade",
        name        = "Void Blade",
        description = "Rapid phantom blade — slices void energy in wide arcs.",
        type        = "weapon",
        rarity      = "rare",
        weaponStats = { damage = 48, cooldown = 0, range = 11, meleeOnly = true },
    },
    {
        id          = "throwing_knives",
        name        = "Throwing Knives",
        description = "Triple burst of razor knives. Blindingly fast.",
        type        = "weapon",
        rarity      = "uncommon",
        weaponStats = { damage = 20, burstCount = 3, cooldown = 0.5, range = 150 },
    },
    {
        id          = "scythe",
        name        = "Void Scythe",
        description = "Enormous sweeping blade that cleaves all enemies in a wide arc.",
        type        = "weapon",
        rarity      = "rare",
        weaponStats = { damage = 70, cooldown = 0, range = 14, meleeOnly = true },
    },
    {
        id          = "war_hammer",
        name        = "Gravity Hammer",
        description = "Slow but devastating — shockwave blast knocks enemies back.",
        type        = "weapon",
        rarity      = "epic",
        weaponStats = { damage = 130, cooldown = 0, range = 9, meleeOnly = true },
    },
    {
        id          = "chain_lightning",
        name        = "Arc Rifle",
        description = "Lightning arcs between up to 4 nearby enemies.",
        type        = "weapon",
        rarity      = "epic",
        weaponStats = { damage = 38, cooldown = 0.85, range = 130 },
    },
    {
        id          = "plasma_cannon",
        name        = "Plasma Cannon",
        description = "Massive plasma burst. Slow fire rate, enormous damage.",
        type        = "weapon",
        rarity      = "epic",
        weaponStats = { damage = 210, cooldown = 2.6, range = 200 },
    },
    {
        id          = "cryo_blaster",
        name        = "Cryo Blaster",
        description = "Freezing projectiles that leave ice patches slowing enemies.",
        type        = "weapon",
        rarity      = "uncommon",
        weaponStats = { damage = 22, cooldown = 0.45, range = 140 },
    },
    {
        id          = "flare_gun",
        name        = "Incendiary Flare",
        description = "Launches a flare that ignites an area for 4 seconds.",
        type        = "weapon",
        rarity      = "rare",
        weaponStats = { damage = 12, aoeRadius = 7, cooldown = 2.2, range = 90, persists = 4 },
    },
    ...
    },
    {
        id          = "void_step",
        name        = "Void Step",
        description = "Dash cooldown −0.5s and dash leaves a damaging void trail.",
        type        = "passive",
        rarity      = "uncommon",
    ...
    },
    {
        id          = "soul_harvest",
        name        = "Soul Harvester",
        description = "Each kill restores 8 HP.",
        type        = "passive",
        rarity      = "uncommon",
        effect      = { killHeal = 8 },
    },
    {
        ...
        description = "Below 35% HP, deal double damage.",
        type        = "passive",
        rarity      = "epic",
        effect      = { berserkThreshold = 0.35 },
    },
    {
        id          = "void_armor",
        name        = "Void Armor",
        description = "Max HP +50 and shield +25.",
        type        = "passive",
        rarity      = "rare",
        effect      = { maxHp = 50, shieldAmount = 25 },
    },
